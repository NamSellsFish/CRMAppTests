...
import org.nam.common.exceptions.InvalidPathForExtentReportFileException;
import org.nam.common.exceptions.ProjectException;
    ...
    public static void openReports(String linkReport) {
        if (OPEN_REPORTS_AFTER_EXECUTION.trim().equalsIgnoreCase(YES)) {
            try {
                ...
                throw new ProjectException("Extent Report file you are trying to reach got IOException while reading the file", ioException.fillInStackTrace());
            }
        }
    }
}
